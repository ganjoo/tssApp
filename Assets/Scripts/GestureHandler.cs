...
public class  GestureHandler : MonoBehaviour {
    ...
    public DrawDotGame.GameManager gameManager;
	...
	public void OnRecognize(RecognitionResult result){
		...
		if (result != RecognitionResult.Empty) {
            ...
            DrawDotGame.GameManager.gestureDraw(result.gesture.id, Mathf.RoundToInt(result.score.score * 100));
            gameManager.setGestureText(result.gesture.id);
        } else {
			textResult.text = "?";
		}
	}
